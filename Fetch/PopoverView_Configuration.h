...
#define kGradientBottomColor [UIColor colorWithRed:0.8078f green:0.8352f blue:0.8470 alpha:kBoxAlpha]

//top color white value in gradient bg
#define kGradientTopColor [UIColor colorWithRed:0.8078f green:0.8352f blue:0.8470 alpha:kBoxAlpha]
